    ...
    <div class="fd-flex p-6 meme_height">
        <div class="col-md-12 p-0">
            ...
            <div class="col-md-12 p-0">
                ...
                list($records) = mysqli_fetch_row(mysqli_query($mysqli, "
                    SELECT count(*) 
                    FROM shity 
                    WHERE czeka='0'
                "));
                ...
                if($records>=1) {
                    ...
                    $pagination->definePattern('<a class="active_pg" href="/page/{LP}">{LP}</a> ', 0);
                    ...
                    if (ceil($ile) == '1' AND $_GET['page'] == '1' || !isset($_GET['page'])) {
                        echo '<a href="/" class="col-md-12 button_next_first"><i class="fas fa-rocket"></i></a>'; 
                        ...
                        echo '<a href="/page/'.$minus_strona.'" class="col-md-12 button_next" style="width: 80%;"><i class="fas fa-arrow-left"></i></a>';
                        echo '<a href="/losowanie" class="col-md-12 przycisk_losowanie"><i class="fas fa-atom"></i></a>';
                        echo $pagination->display();
                    } elseif (!isset($_GET['page']) AND ceil($ile) != '1'){     
                        echo '<a href="/page/'.$pierwsza_strona.'" class="col-md-12 button_next_first"><i class="fas fa-arrow-right"></i></a>';
                        echo '<a href="/losowanie" class="col-md-12 przycisk_losowanie"><i class="fas fa-atom"></i></a>';         
                        echo $pagination->display();      
                    } elseif($_GET['page'] > 1 AND $_GET['page'] < ceil($ile)){
                        echo '<a href="/page/'.$minus_strona.'" class="col-md-12 button_next"><i class="fas fa-arrow-left"></i></a>';
                        echo '<a href="/page/'.$plus_strona.'" class="col-md-12 button_back"><i class="fas fa-arrow-right"></i></a>';
                        echo '<a href="/losowanie" class="col-md-12 przycisk_losowanie"><i class="fas fa-atom"></i></a>';
                        echo $pagination->display();
                    ...
                    echo '<div class="col-lg-12 mt-5 noMemeInfo">
                        <h1 class="admin_h1 pb-4">Brak memów na stronie głownej</h1>
                        <a href="/" class="col-md-12 button_next_first" style="width: 100%;"><i class="fas fa-rocket"></i></a>
                    </div>';
                }
                ?>
